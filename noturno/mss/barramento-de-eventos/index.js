...
app.post('/eventos', (req, res) => {
    ...
    axios.post('http://lembretes:4000/eventos', evento).catch((err) => {})
    axios.post('http://observacoes:5001/eventos', evento).catch((err) => {})
    //envia o evento para o microsserviço de consulta
    axios.post('http://consulta:6000/eventos', evento).catch((err) => {})
    //envia o evento para o microsservico de classificação
    axios.post('http://classificacao:7001/eventos', evento).catch((err) => {})
